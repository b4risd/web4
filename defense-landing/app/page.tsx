    ...
    <div className="font-sans min-h-screen">
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-black/70 backdrop-blur">
        <div className="container-centered h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-white/70">
            ...
            <a href="#products" className="hover:text-white transition-colors">Ürün</a>
            ...
            <a href="#pricing" className="hover:text-white transition-colors">Fiyat</a>
        ...
        <div className="container-centered py-24 md:py-28 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-9 flex flex-col sm:flex-row gap-3 justify-center">
              <a className="inline-flex h-12 items-center justify-center rounded-full bg-white px-6 text-black font-medium hover:bg-white/90 transition-colors" href="#contact">Teklif Al</a>
        ...
        <div className="container-centered py-20">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={p.name} className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
      ...
      <section id="products" className="border-t border-white/10 bg-black">
        <div className="container-centered py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative">
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] aspect-video flex items-center justify-center text-white/60">
              Görev Sistemi Ekranı
            </div>
            <div className="absolute -bottom-6 -right-6 w-40 h-28 rounded-xl border border-white/10 bg-white/[0.04] backdrop-blur-sm hidden md:flex items-center justify-center text-xs text-white/60">
          ...
          <div className="max-w-xl mx-auto lg:mx-0">
            ...
            <div className="mt-6 flex gap-3">
              <a className="inline-flex h-11 items-center justify-center rounded-full bg-white px-6 text-black font-medium hover:bg-white/90 transition-colors" href="#contact">Teklif Al</a>
              <a className="inline-flex h-11 items-center justify-center rounded-full border border-white/15 px-6 text-white/90 hover:bg-white/5 transition-colors" href="#programs">Programlar</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-centered py-20">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              <article key={n.title} className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
        ...
        <div className="container-centered py-16">
          ...
          <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 opacity-80">
            {["STANAG 4586","Link-16","VMF","MIL-STD-810","MIL-STD-461","DO-178C","FIPS 140-3","ISO 27001"].map((item) => (
              <div key={item} className="h-12 rounded border border-white/10 flex items-center justify-center text-xs text-white/70">
                {item}
              </div>
            ))}
          </div>
      ...
      <section id="faq" className="border-t border-white/10 bg-black">
        <div className="container-centered py-20">
          ...
          <div className="mt-8 max-w-3xl mx-auto divide-y divide-white/10 rounded-2xl border border-white/10 bg-white/[0.04]">
            {[
      ...
      <section id="contact" className="border-t border-white/10 bg-black">
        <div className="container-centered py-20">
          ...
          <div className="mt-8 max-w-2xl mx-auto rounded-2xl border border-white/10 bg-white/[0.04] p-6">
