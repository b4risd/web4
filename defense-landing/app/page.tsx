    ...
    <div className="font-sans min-h-screen">
      ...
      <header className="sticky top-0 z-40 bg-transparent border-0 relative">
        ...
        <div className="container-centered h-20 flex items-center justify-center relative z-10">
          <img src="/logo/savsa-tr-logo.png" alt="SAVSA.TR" className="h-12 md:h-14 lg:h-16 w-auto absolute left-4 top-1/2 -translate-y-1/2 border-0 outline-none ring-0 drop-shadow-none m-0 p-0 bg-transparent" />
